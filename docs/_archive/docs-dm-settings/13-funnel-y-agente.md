...
Este prompt vive en el Set node `System Prompt` del workflow `agent-run` en n8n (campo `staticPrompt`), con fuente versionada en `docs/n8n/prompts/setter-v1.md`. **No vive en código TypeScript ni en DB**. Ver `docs/n8n/nodes/00c-system-prompt.md`.
