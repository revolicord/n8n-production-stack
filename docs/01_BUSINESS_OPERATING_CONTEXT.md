...
### 3.1 Comentarios en Posts / Reels
...
| **n8n** | Orquestador: recibe eventos de ManyChat, aplica lógica, llama al agente, actualiza CRM |
| **Servidor propio** | Ejecuta el modelo de IA (agente setter), mantiene contexto de conversación |
...
> **Importante:** El setter humano actual sigue activo durante la fase de transición. El agente debe documentar su proceso exacto para poder replicarlo fielmente.
