...
BEGIN;
TRUNCATE api.turns, api.messages_raw, api.lead_followup_log, api.stage_transitions, api.lead_stages, api.lead_crons, api.dead_letter_queue, api.conversations, api.subscribers RESTART IDENTITY CASCADE;
